		...
		<Navbar let:hidden let:toggle>
			...
			<div class="flex items-center w-full lg:w-auto">
				...
				<div class="lg:self-center flex items-center mb-4 lg:mb-0 hidden mr-3 lg:flex">
					...
					<div>
						<Button on:click={() => showModal = true}>SQL Converter</Button>
					</div>
				</div>
			</div>
		</Navbar>
...
<Modal bind:show={showModal}>
	<div slot="body">
		<p>This is your modal content. Replace this with your actual SQL Converter code.</p>
	</div>
	<div slot="footer">
...
<footer class="bg-white dark:bg-gray-900">
	<div class="w-full container mx-auto p-4 md:px-6 md:py-8">
		<div class="sm:flex sm:items-center sm:justify-between">
			<NavBrand href="/">
				<span class="self-center whitespace-nowrap text-xl font-semibold dark:text-white">&lt;/Dev&gt;star</span>
			</NavBrand>
			<FooterLinkGroup>
		...
		<FooterCopyright href="/" by="Developerstar™" year="2023" />
	</div>
</footer>
